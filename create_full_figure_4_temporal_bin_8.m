...
elseif strcmp(TYPE, 'wake') && FILTERED == true
    SLOPE_MULTIPLIER = -1;
    CORRECTED_NEURON_PREFERRED_ANGLE_SHIFT = 0.1 * pi;
    
    EXAMPLE_NEURONS = [43 45 47 62 55 56 46 61];
    
    PANEL_A_XLIM = [-0.018 0.015];
    PANEL_A_YLIM = [-0.017 0.016];
    
    PANEL_D_XLIM = [-0.7 0.7];
    PANEL_D_YLIM = [-0.8 0.6];
elseif strcmp(TYPE, 'rem') && FILTERED == true
    SLOPE_MULTIPLIER = 1;
    CORRECTED_NEURON_PREFERRED_ANGLE_SHIFT = 0.2 * pi;
    
    % Mouse28-140313 all rem
    EXAMPLE_NEURONS = [46 45 57 62 59 44 55 24];

    PANEL_A_XLIM = [-0.025 0.025];
    PANEL_A_YLIM = [-0.028 0.022];
    
    PANEL_D_XLIM = [-0.7 0.7];
    PANEL_D_YLIM = [-0.7 0.7];
else
